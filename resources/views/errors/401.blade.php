        ...
        <div class="row align-items-center text-center py-sm-5">
          ...
          <style type="text/css">
              ...
              .st13{fill:url(#SVGID_00000103980266939832754290000005538789883632006285_);}
                ...
                <!-- SVG END -->
                <!-- 404 info -->
                <h1 class="display-1 mt-4">401</h1>
                <h2 class="mb-2 h1">Unauthorized response status code!</h2>
                <p>You are not authorized to enter this page, participate in it, or search for it</p>
                <!-- Button -->
                <a class="btn btn-primary-soft btn-sm" href="{{route('welcome')}}">Got to home page</a>
            </div>
            <!-- Error 404 START -->
        </div>
        <!-- Extra space -->
