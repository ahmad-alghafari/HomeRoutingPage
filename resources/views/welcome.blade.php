            ...
            <div class="container">
                ...
                <div class="row g-4 g-lg-5">
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <p class="mb-0">Place voice no arises along to. Parlors waiting so against me no. Wishing
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <p class="mb-0">Handsome met debating sir dwelling age material. As style lived he worse
                            dried. visitors subjects distance.</p>
                    </div>
                    <!-- Feature END -->
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <p class="mb-0">Yet uncommonly his ten who diminution astonished. Demesne new manners savings
                            staying had. </p>
                    </div>
                    <!-- Feature END -->
                </div>
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="ms-4">
                                    ...
                                    <p class="lead mb-4">Enjoy special interactive features such as Live Battles,
                                        Interactive Gifts, Happy Moments & Exclusive Posts to help you rise the ranks
        ...
        <div class="bg- light py-3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <!-- Copyright START -->
                        <p class="text-center text-lg-end mb-0">©2023 <a class="text-body" target="_blank"
