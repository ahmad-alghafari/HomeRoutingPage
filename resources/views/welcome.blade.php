...
<header class="navbar-light header-static bg-transparent">
    ...
    <div class="container">
      ...
      <div class="row g-0 align-items-center mt-2 position-relative z-index-1">
        <div class="col-lg-4">
          ...
          <div class="iphone-x iphone-x-small" style="background: url({{asset("import/assets/images/mockup/app-placeholder2.jpg")}}); background-size: 100%;">
            <i></i>
            <b></b>
          </div>
          <!-- iphone-x mockup END -->
            ...
            <div class="mac_scaler">
              <div class="mac_holder">
                <div class="mac_screen">
                  ...
                  <div class="mac_screen_content" style="background:url({{asset("import/assets/images/mockup/mac-placeholder.jpg")}}); background-size: 100%;">
                  </div>
                </div>
    ...
    <div class="container">
      ...
      <div class="row g-4 g-lg-5">
        ...
        <div class="col-md-4 text-center">
          <img class="h-100px mb-4" src="{{asset("import/assets/images/elements/02.svg")}}" >
        ...
        <!-- Feature START -->
        <div class="col-md-4 text-center">
          <img class="h-100px mb-4" src="{{asset("import/assets/images/elements/01.svg")}}" >
      ...
      <div class="row g-4 g-lg-5 align-items-center">
        ...
        <div class="col-lg-8">
          <div class="card card-body bg-mode shadow-none border-0 p-4 p-sm-5 pb-sm-0 overflow-hidden">
            <div class="row g-4">
              <div class="col-md-6">
                <!-- Info -->
                <img class="h-50px" src="{{asset("import/assets/images/elements/05.svg")}}" alt="">
              ...
              <div class="col-md-6 text-end"> 
                <!-- image -->
                <!-- iphone-x mockup START -->
                  <div class="iphone-x iphone-x-small iphone-x-half mb-n5 mt-0" style="background: url({{asset("import/assets/images/mockup/app-placeholder3.jpg")}}); background-size: 100%;">
                    <i></i>
                    <b></b>
                  </div>
                  <!-- iphone-x mockup END -->
        ...
        <div class="col-md-4">
          <div class="card card-body bg-mode shadow-none border-0 p-4 p-lg-5">
            <!-- Image -->
            <div>
              <img class="h-50px" src="{{asset("import/assets/images/elements/06.svg")}}" alt="">
            </div>
            <!-- Info -->
        ...
        <div class="col-lg-10 ms-auto">
          <div class="row g-4 align-items-center">
            <div class="col-md-5 col-lg-5 position-relative">
              <!-- Image -->
              <img class="rounded-circle" src="{{asset("import/assets/images/post/4by3/01.jpg")}}">
              <!-- Chat START -->
              <div class="position-absolute top-50 start-0 translate-middle d-none d-lg-block">
                ...
                <div class="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                  ...
                  <div class="avatar avatar-xs me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="{{asset("import/assets/images/avatar/12.jpg")}}"> </a>
                  </div>
                  <!-- Comment box  -->
                  <div class="d-flex">
                ...
                <div class="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xs me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="{{asset("import/assets/images/avatar/10.jpg")}}"> </a>
                  </div>
                <!-- Comment box  -->
                  <div class="d-flex">
                ...
                <div class="bg-mode border p-3 rounded-3 rounded-start-top-0 d-flex align-items-center mb-3">
                  <!-- Avatar -->
                  <div class="avatar avatar-xs me-3">
                    <a href="#!"> <img class="avatar-img rounded-circle" src="{{asset("import/assets/images/avatar/09.jpg")}}"> </a>
                  </div>
                  <!-- Comment box  -->
                    <div class="d-flex">
  ...
  <section class="py-4 py-sm-5 position-relative">
    <!-- Svg decoration START -->
    <div class="position-absolute top-0 start-0 mt-n5 pt-n5">
      <img class="h-300px blur-9" src="{{asset("import/assets/images/elements/06.svg")}}" alt="">
    </div>
    <!-- Svg decoration END -->
        ...
        <div class="col-lg-10 mx-auto">
          <div class="row g-4 align-items-center position-relative z-index-1">
            <div class="col-md-6">
              <div class="me-4">
                ...
                <div class="mb-3 d-flex align-items-start">
                  <img class="h-40px" src="{{asset("import/assets/images/elements/04.svg")}}" alt="">
                  <div class="ms-4">
                ...
                <!-- Support artists   -->
                <div class="mb-3 d-flex align-items-start">
                  <img class="h-40px" src="{{asset("import/assets/images/elements/10.svg")}}" alt="">
                  <div class="ms-4">
            ...
            <div class="col-md-6 col-lg-5 position-relative">
              <!-- Image -->
              <img class="rounded-circle" src="{{asset("import/assets/images/post/4by3/02.jpg")}}" alt="">
              ...
              <div class="position-absolute top-50 start-100 translate-middle d-none d-lg-block">
                ...
                <div class="position-absolute top-0 end-0 m-3 z-index-1">
                  <div class="avatar avatar-lg">
                    <a href="#!"><img class="avatar-img rounded border border-white border-1" src="{{asset("import/assets/images/post/1by1/07.jpg")}}" alt=""></a>
                  </div>
                </div>
                ...
                <div class="player-wrapper plyr__controls-none rounded-3">
                  <video class="player-html" crossorigin="anonymous" autoplay loop muted="" controls>
                    <source src="{{asset("import/assets/images/videos/video-call.mp4")}}" type="video/mp4">
                  </video>
                </div>
                <!-- HTML video END -->
      ...
      <div class="card card-body bg-light shadow-none border-0 p-4 p-sm-5 text-center">
          <div class="col-lg-8 mx-auto">
            ...
            <div class="d-flex justify-content-center">
              <a href="app-download.html"><img class="h-40px" src="{{asset("import/assets/images/app-store.svg")}}" alt="app-store"></a>
              <a href="app-download.html"><img class="h-40px ms-1 ms-sm-2" src="{{asset("import/assets/images/google-play.svg")}}" alt="google-play"></a>
            </div>
            <!-- Box List -->
  ...
  <div class="container">
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3">
        <!-- Footer Widget -->
        <img src="{{asset("import/assets/images/logo.svg")}}" alt="">
  ...
  <div class="bg- light py-3">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6">
          <!-- Copyright START -->
          <p class="text-center text-lg-end mb-0">©2023 <a class="text-body" target="_blank" href="https://www.webestica.com"> Webestica </a>All rights reserved.</p>
          <!-- Copyright END -->
        </div>
      </div>
    </div>
