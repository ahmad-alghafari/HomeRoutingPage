            ...
            <ul>
                <li class="has-sub-menu"><a href="#"><i class="ti-home"></i> <span>Dashboard</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a href="{{route("admin.dashboard")}}"><span>Statistics (Default)</span></a></li>
                        <li><a href="{{route("admin.logs")}}"><span>Monitor Logs</span></a></li>
                ...
                <li class="has-sub-menu"><a href="#"><i class="fa fa-user-circle" ></i> <span>Users</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a href="{{route('admin.users.all')}}"><span>Show All</span></a></li>
                        <li><a href="{{route('admin.users.banded')}}"><span>Banded Users</span></a></li>
                    </ul>
                </li>
